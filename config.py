...
def parse_args():
	...
	parser.add_argument('-d', '--darknet', dest='DARKNET', action='store_true', default=True, help="Specifies to use the Darknet classifier")
	
	parser.add_argument('-t', '--tesseract', dest='TESSERACT', action='store_true', default=True,  help="Use the local Tesseract OCR engine")
	...
	parser.add_argument('--weights', dest="DARKNET_WEIGHTS", default="yolo-obj_3000.weights ", help="Weights for Darknet")
